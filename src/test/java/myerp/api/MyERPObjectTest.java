 ...
 */
public class MyERPObjectTest {

  private static class TestBase extends MyERPObject {
    @Field
    String f1;
  }
  ...
  public void testContains() {
    ...
    assertFalse(o.containsValue(MyERPObjectTest.this));
    o.put("f-4", MyERPObjectTest.this);
    assertTrue(o.containsValue(MyERPObjectTest.this));
  }
